 ...
 */
export function revertPersonFaceAssignmentHistory({ historyId, id }: {
    historyId: string;
    id: string;
}, opts?: Oazapfts.RequestOpts) {
    return oazapfts.ok(oazapfts.fetchJson<{
...
/**
 * Get person face suggestions
 */
export function getPersonFaceSuggestions({ id, maxDistance, page, size }: {
    id: string;
    maxDistance?: number;
    page?: number;
    size?: number;
 ...
 */
export function respondToPersonFaceSuggestion({ faceId, id, personFaceSuggestionFeedbackDto }: {
    faceId: string;
    id: string;
    personFaceSuggestionFeedbackDto: PersonFaceSuggestionFeedbackDto;
}, opts?: Oazapfts.RequestOpts) {
    return oazapfts.ok(oazapfts.fetchJson<{
        status: 200;
        data: PersonFaceSuggestionFeedbackResponseDto;
    }>(`/people/${encodeURIComponent(id)}/face-suggestions/${encodeURIComponent(faceId)}/feedback`, oazapfts.json({
        ...opts,
        method: "POST",
        body: personFaceSuggestionFeedbackDto
    })));
}
/**
