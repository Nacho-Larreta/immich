...
class StreamingTask implements ffi.Finalizable {
  ...
  factory StreamingTask({
      ...
      onComplete: ncb.ObjCBlock_ffiVoid_NSError.listener((error) {
        try {
          if (error != null) {
            ...
            if (!controller.isClosed) controller.addError(mappedError);
          }
    ...
    task = StreamingTask._(nsTask, completer, controller, lifecycle);
  ...
  Future<void> cancelAndWait() => _lifecycle.cancelAndWait(_nsTask.cancel);
}
