...
Widget userAvatar(BuildContext context, UserDto u, {required RemoteImageProviderFactory remoteImages, double? radius}) {
  ...
  return CircleAvatar(
    ...
    foregroundImage: remoteImages.image(url: url, edited: true, kind: MediaRequestKind.thumbnail),
