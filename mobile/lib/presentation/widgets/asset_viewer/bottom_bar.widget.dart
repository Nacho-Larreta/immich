...
class ViewerBottomBar extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final actions = <Widget>[
      ...
      if (!isInLockedView) ...[
        if (asset.isLocalOnly && canMutate) const UploadActionButton(source: ActionSource.viewer),
        // edit sync was added in 2.6.0
        if (asset.isEditable && canMutate && serverInfo.serverVersion >= const SemVer(major: 2, minor: 6, patch: 0))
