...
class BackgroundWorkerApiImpl: BackgroundWorkerFgHostApi {
  ...
  private static let refreshTaskID = "com.nacholarreta.nachofotos.background.refreshUpload"
  private static let processingTaskID = "com.nacholarreta.nachofotos.background.processingUpload"
