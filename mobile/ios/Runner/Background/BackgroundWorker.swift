...
e -l objc -- (void)[[BGTaskScheduler sharedScheduler] _simulateLaunchForTaskWithIdentifier:@"com.nacholarreta.nachofotos.background.refreshUpload"]
 
 ## For background processing (long-running upload):
 
e -l objc -- (void)[[BGTaskScheduler sharedScheduler] _simulateLaunchForTaskWithIdentifier:@"com.nacholarreta.nachofotos.background.processingUpload"]

 * To simulate task expiration (useful for testing expiration handlers):
 
e -l objc -- (void)[[BGTaskScheduler sharedScheduler] _simulateExpirationForTaskWithIdentifier:@"com.nacholarreta.nachofotos.background.refreshUpload"]
 
e -l objc -- (void)[[BGTaskScheduler sharedScheduler] _simulateExpirationForTaskWithIdentifier:@"com.nacholarreta.nachofotos.background.processingUpload"]
